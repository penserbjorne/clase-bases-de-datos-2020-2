...
PROFILE_PRODUCTS_LIST=rdbms,precomp,plsql,oraolap,odbc
...
SDOSRC=$(SDOHOME)src/
LIBORDSDONAME=ordsdo$(SDO_LIB_VERSION)
LIBORDSDO=$(LIB_PREFIX)$(LIBORDSDONAME).$(LIB_EXT)
LLIBORDSDO=$(LDLIBFLAG)$(LIB_PREFIX)$(LIBORDSDONAME).$(LIB_EXT)
LIBSDOGDALNAME=sdogdal
LOC_LIBSDOGDALLIB=$(LIB_PREFIX)$(LIBSDOGDALNAME).$(LIB_EXT)
LIBSDOGDALLIB=$(SDOLIB)$(LOC_LIBSDOGDALLIB)
LOC_LIBSDOGDALSHR=$(LIB_PREFIX)$(LIBSDOGDALNAME).$(SO_EXT)
LIBSDOGDALSHR = $(SDOLIB)$(LOC_LIBSDOGDALSHR)
EAR_EXT=ear
WAR_EXT=war
ZIP_EXT=zip
...
JAR_SDOOBJTRKRDEMO=$(SDOJLIB)fruitfly.$(JAR_EXT)
JAR_SDOCSWLOADER=$(SDOJLIB)sdocswloader.$(JAR_EXT)
JAR_SDOISOMETA=$(SDOJLIB)sdoisometa.$(JAR_EXT)
...
JDBC_MAJOR_VERSION = $(MAJORVSN)
JDBC_MINOR_VERSION = $(MINORVSN)
JDBC_VERSION_STRING = $(BANNERVERSION)
...
SKJCXLIBDIR=$(ORACLE_HOME)/usm/$(LIBDIR)/

SKJCXNAME=skjcx
LIBSKJCXNAME=$(SKJCXNAME)$(LIBMAJORVSN)
LLIBSKJCX=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSKJCXNAME)$(LIB_SUFFIX)
LIBSKJCX_USM=$(SKJCXLIBDIR)$(LIB_PREFIX)$(LIBSKJCXNAME).$(SO_EXT)


SKJCXKRNAME=skjcxkr
LIBSKJCXKRNAME=$(SKJCXKRNAME)
LLIBSKJCXKR=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSKJCXKRNAME)$(LIB_SUFFIX)
LIBSKJCXKR_USM=$(SKJCXLIBDIR)$(LIB_PREFIX)$(LIBSKJCXKRNAME).$(SO_EXT)

SKJCXGNAME=skjcxg
LIBSKJCXGNAME=$(SKJCXGNAME)
LLIBSKJCXG=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSKJCXGNAME)$(LIB_SUFFIX)
LIBSKJCXG_USM=$(SKJCXLIBDIR)$(LIB_PREFIX)$(LIBSKJCXGNAME).$(SO_EXT)

SKJCXUNAME=skjcxu
LIBSKJCXUNAME=$(SKJCXUNAME)
LLIBSKJCXU=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSKJCXUNAME)$(LIB_SUFFIX)
LIBSKJCXU_USM=$(SKJCXLIBDIR)$(LIB_PREFIX)$(LIBSKJCXUNAME).$(SO_EXT)

SKJCXDNAME=skjcxd
LIBSKJCXDNAME=$(SKJCXDNAME)
LLIBSKJCXD=$(LDLIBFLAG)$(ILIB_PREFIX)$(LIBSKJCXDNAME)$(LIB_SUFFIX)
LIBSKJCXD_USM=$(SKJCXLIBDIR)$(LIB_PREFIX)$(LIBSKJCXDNAME).$(SO_EXT)
...
LIBS=$(LOC_LIBCOMMON) $(LOC_LIBGENERIC) $(LOC_LIBCLIENT) $(LOC_LIBSERVER) $(LOC_LIBPERFSRV) \
     $(LOC_LIBVSN) $(LOC_LIBAGENT) $(LOC_LIBDBTOOLS) \
     ...
     $(LOC_LIBSKJCX) $(LOC_LIBRQEXT) $(LOC_LIBOFS) $(LOC_LIBORABASE)

SHLIBS=$(LIBODM) $(LIBNFSODM) $(LIBOPCODM) $(LIBOFS) $(LIBASMCLNTSH) $(LIBORABASE) \
       $(LIBVSN) $(S_SHLIBS)
...
OPCTEST_UTMAI = $(RDBMSLIB)opctest_ut.$(OBJ_EXT)
OBJSTORE_UPLOAD_UTMAI = $(RDBMSLIB)objstore_upload.$(OBJ_EXT)
ORADNFSAUX = 
...
ORAVERSIONMAI=$(RDBMSLIB)oraversion.$(OBJ_EXT)
...
OPCTEST_UT=$(RDBMSBIN)opctest_ut$(EXE_SUFFIX)
OBJSTORE_UPLOAD=$(RDBMSBIN)objstore_upload$(EXE_SUFFIX)
...
ORAVERSION=$(RDBMSBIN)oraversion$(EXE_SUFFIX)
...
DBGMTT_LINKLINE=$(LINK) $(OPT) $(DBGMTTMAI) $(LIBGENERIC) $(LLIBCORE) \
		$(OCISHAREDLIBS) $(LLIBSLAX) $(LINKTTLIBS)
ORION_LINKLINE=$(LINK) $(OPT) $(ORIONMAI) $(LLIBORION) $(LLIBCLNTSH) \
...
OPCTEST_UT_LINKLINE=$(LINK) $(OPCTEST_UTMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
OBJSTORE_UPLOAD_LINKLINE=$(LINK) $(OBJSTORE_UPLOAD_UTMAI) $(LLIBGENERIC) $(LLIBCORE) $(LLIBCOMMON) $(SUIDLINKLDLIBS)
...
MAPSGA_LINKLINE=$(LINK) $(OPT) $(MAPSGAMAI) $(SSDBED) $(KSMS) \
	$(LINKTTLIBS) 
ORAPWD_LINKLINE=$(LINK) $(OPT) $(PWDMAI) $(PWDCLSR) $(SSDBED) $(ASMCLNTSH_LIBS) $(HAS_SKGXNLIBS) $(LLIBHASGEN) $(LLIBOCR) $(CLSRLIBS_SERVER) $(LLIBOCRBACKEND) $(LLIBOCRUTL) $(LINKTTLIBS)
TKPROF_LINKLINE=$(LINK) $(OPT) $(TKPMAI) $(SSDBED) $(LINKTTLIBS)
PLSHPROF_LINKLINE=$(LINK) $(OPT) $(PLSTMAI) $(LLIBCLNTSH) \
...
HSALLOCI_LINKLINE=$(LINK) $(OPT) $(HSALLMAI) $(HSALIB_SUBSET1) \
	$(HS_OCI_DRIVER) $(HS_XASWITCH_ORA) $(HSALIB_SUBSET2)
HSDEPXA_LINKLINE=$(LINK) $(OPT) $(HSDEPMAI) $(HSALIB_SUBSET1) \
	$(HS_DEP_DRIVER) $(HSALIB_SUBSET2)
HSOTS_LINKLINE=$(LINK) $(OPT) $(HSOTSMAI) $(HSALIB_SUBSET1) \
	$(HS_OTS_DRIVER) $(HS_XASWITCH_ORA) $(HSALIB_SUBSET2)
...
KFED_LINKLINE=$(LINK) $(S0MAIN) $(SSKFEDED) $(SKFEDPT) $(LLIBDBTOOLS) \
...
ORAVERSION_LINKLINE=$(LINK) $(OPT) $(ORAVERSIONMAI) $(LINKLDLIBS)
...
LIBOCIEI_SHIP_DIR=instantclient_$(RDBMS_VERSION)_$(VSNRU)
LIBOCIEI_SHIP_BASE=$(LIBOCIEI_BASE)/$(LIBOCIEI_SHIP_DIR)
LIBOCIEI_SDK_BASE=$(LIBOCIEI_SHIP_BASE)/sdk
LIBOCIEI_NETWORK_BASE=$(LIBOCIEI_SHIP_BASE)/network
LIBOCIEI_NETWORK_DIR=$(LIBOCIEI_SHIP_DIR)/network
...
BUILD_LIBOCIEI_BASIC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	if [ -f $(LIBOCIEI_BASE)/$(LIB_PREFIX)$(LIBOCIEINAME).$(SO_EXT) ]; then \
	  $(CP) $(LIBOCIEI_BASE)/$(LIB_PREFIX)$(LIBOCIEINAME).$(SO_EXT) $(LIBOCIEI_SHIP_BASE); \
          chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)$(LIBOCIEINAME).$(SO_EXT); \
	else \
	  $(CP) $(ORACLE_HOME)/instantclient$(HYBRID_IC_SUF)/libociei.$(SO_EXT) $(LIBOCIEI_SHIP_BASE); \
          chmod 755 $(LIBOCIEI_SHIP_BASE)/libociei.$(SO_EXT); \
	fi; \
        mkdir $(LIBOCIEI_NETWORK_BASE); \
        mkdir $(LIBOCIEI_NETWORK_BASE)/admin; \
        chmod 755 $(LIBOCIEI_NETWORK_BASE); \
        chmod 755 $(LIBOCIEI_NETWORK_BASE)/admin; \
        echo "============================================================================" > $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "This is the default directory for Oracle Network and Oracle Client" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "configuration files. You can place files such as tnsnames.ora, sqlnet.ora" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "and oraaccess.xml in this directory." >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "NOTE:" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "If you set an environment variable TNS_ADMIN to another directory containing" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "configuration files, they will be used instead of the files in this default" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "directory." >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        echo "============================================================================" >> $(LIBOCIEI_NETWORK_BASE)/admin/README; \
        chmod 644 $(LIBOCIEI_NETWORK_BASE)/admin/README; \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) genezi$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/genezi$(HYBRID_IC_SUF); \
        ...
        chmod 644 $(LIBOCIEI_SHIP_BASE)/BASIC_README; \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) adrci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        $(CP) uidrvci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/adrci$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/uidrvci$(HYBRID_IC_SUF); \
	...
	$(CP) xstreams.jar $(LIBOCIEI_SHIP_BASE); \
        chmod 644 $(LIBOCIEI_SHIP_BASE)/xstreams.jar; \
	$(CD) $(LIBOCIEI_SHIP_BASE); \
	$(LNS) $(LIB_PREFIX)$(LIBCLNTSHNAME).$(SO_EXT).$(RDBMS_VERSION).$(RDBMS_MINOR_VERSION) $(LIB_PREFIX)$(LIBCLNTSHNAME).$(SO_EXT); \
	$(LNS) $(LIB_PREFIX)$(LIBOCCINAME).$(SO_EXT).$(RDBMS_VERSION).$(RDBMS_MINOR_VERSION) $(LIB_PREFIX)$(LIBOCCINAME).$(SO_EXT); \
	$(CD) $(LIBOCIEI_BASE); \
	$(RMF) $(LIBOCIEI_BASIC_ZIP); \
	$(ZIPEXE) -y $(LIBOCIEI_BASIC_ZIP) $(LIBOCIEI_SHIP_DIR)/* $(LIBOCIEI_NETWORK_DIR)/admin $(LIBOCIEI_NETWORK_DIR)/admin/README; \
	$(RMRF) $(LIBOCIEI_SHIP_BASE)
...
BUILD_LIBOCIEI_BASIC_LITE_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	if [ -f $(LIBOCIEI_BASE)/light/$(LIB_PREFIX)$(LIBLIGHTOCIEINAME).$(SO_EXT) ]; then \
	  $(CP) $(LIBOCIEI_BASE)/light/$(LIB_PREFIX)$(LIBLIGHTOCIEINAME).$(SO_EXT) $(LIBOCIEI_SHIP_BASE); \
          chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)$(LIBLIGHTOCIEINAME).$(SO_EXT); \
	else \
	  $(CP) $(ORACLE_HOME)/instantclient$(HYBRID_IC_SUF)/light/libociicus.$(SO_EXT) $(LIBOCIEI_SHIP_BASE); \
          chmod 755 $(LIBOCIEI_SHIP_BASE)/libociicus.$(SO_EXT); \
	fi; \
        chmod 644 $(LIBOCIEI_NETWORK_BASE)/admin/README; \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) genezi$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/genezi$(HYBRID_IC_SUF); \
        echo "Basic Light Package Information" > $(LIBOCIEI_SHIP_BASE)/BASIC_LITE_README; \
        ...
        chmod 644 $(LIBOCIEI_SHIP_BASE)/BASIC_LITE_README; \
	$(CD) $(ORACLE_HOME)/bin; \
	$(CP) adrci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        $(CP) uidrvci$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/adrci$(HYBRID_IC_SUF); \
	...
	$(ZIPEXE) -y $(LIBOCIEI_BASIC_LITE_ZIP) $(LIBOCIEI_SHIP_DIR)/* $(LIBOCIEI_NETWORK_DIR)/admin $(LIBOCIEI_NETWORK_DIR)/admin/README; \
	$(RMRF) $(LIBOCIEI_SHIP_BASE)
...
BUILD_LIBOCIEI_JDBC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(BUILD_LIBOCIEI_JDBC_EXTRA_ZIP); \
        ...
        chmod 0644 $(LIBOCIEI_SHIP_BASE)/JDBC_README; \
...
BUILD_LIBOCIEI_TOOLS_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) expdp$(HYBRID_IC_SUF) $(LIBOCIEI_SHIP_BASE); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)nfsodm$(RDBMS_VERSION).$(SO_EXT); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/wrc$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/sqlldr$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/exp$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/imp$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/impdp$(HYBRID_IC_SUF); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/expdp$(HYBRID_IC_SUF); \
	$(CD) $(LIBOCIEI_BASE); \
        ...
        chmod 644 $(LIBOCIEI_SHIP_BASE)/TOOLS_README; \
...
BUILD_LIBOCIEI_SQLPLUS_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	$(CP) glogin.sql $(LIBOCIEI_SHIP_BASE); \
        echo "SQL*Plus Package Information" > $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        echo "============================" >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        echo "" >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        date >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        echo "" >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)sqlplus.$(SO_EXT); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)sqlplusic.$(SO_EXT); \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/sqlplus$(HYBRID_IC_SUF); \
        chmod 644 $(LIBOCIEI_SHIP_BASE)/glogin.sql; \
        $(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
        chmod 644 $(LIBOCIEI_SHIP_BASE)/SQLPLUS_README; \
	$(CD) $(LIBOCIEI_BASE); \
...
BUILD_LIBOCIEI_ODBC_ZIP=$(LIBOCIEI_EXIT_ON_ERROR); \
	...
	echo "ODBC Package Information" > $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	echo "========================" >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	echo "" >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	date >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	echo "" >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	$(EXEC_GENEZI) -t >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	$(CD) $(ORACLE_HOME)/odbc/doc; \
	cat odbc_ic_readme_unix_seed.doc >> $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
	$(CD) $(ORACLE_HOME)/odbc/utl; \
	$(CP) odbc_update_ini.sh  $(LIBOCIEI_SHIP_BASE); \
        chmod 644 $(LIBOCIEI_SHIP_BASE)/ODBC_README; \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/odbc_update_ini.sh; \
        chmod 755 $(LIBOCIEI_SHIP_BASE)/$(LIB_PREFIX)sqora.$(SO_EXT).$(RDBMS_VERSION).$(RDBMS_MINOR_VERSION); \
...
FLATTEN_FILE_LIST=$(CD) $(ORACLE_HOME)/rdbms/install/instantclient/ ; \
        $(RMF) flatten_file_list; \
        $(CP) flatten_file_list.pp.repos flatten_file_list.pp; \
        $(CHMOD) 0755 flatten_file_list.pp; \
        $(SED) -e "s/@RDBMS_VERSION@/$(RDBMS_VERSION)/" \
        -e "s/@RDBMS_MINOR_VERSION@/$(RDBMS_MINOR_VERSION)/" flatten_file_list.pp > flatten_file_list; \
        $(RMF) flatten_file_list.pp
...
LIBOPC_ZIP=$(RDBMSLIB)libopc.zip
LIBOPC_ZIP_BASE=$(RDBMSLIB)
LIBOPC_ZIP_SHIP_DIR=libopc
LIBOPC_ZIP_SHIP_BASE=$(LIBOPC_ZIP_BASE)$(LIBOPC_ZIP_SHIP_DIR)

LIBRA_ZIP=$(RDBMSLIB)libra.zip
LIBRA_ZIP_BASE=$(RDBMSLIB)
LIBRA_ZIP_SHIP_DIR=libra
LIBRA_ZIP_SHIP_BASE=$(LIBRA_ZIP_BASE)$(LIBRA_ZIP_SHIP_DIR)

LIBOSBWS_ZIP=$(RDBMSLIB)libosbws.zip
LIBOSBWS_ZIP_BASE=$(RDBMSLIB)
LIBOSBWS_ZIP_SHIP_DIR=libosbws
LIBOSBWS_ZIP_SHIP_BASE=$(LIBOSBWS_ZIP_BASE)$(LIBOSBWS_ZIP_SHIP_DIR)

LIBOPC_EXIT_ON_ERROR=set -e

BUILD_LIBOPC_ZIP=$(LIBOPC_EXIT_ON_ERROR);\
	$(RMF) $(LIBOPC_ZIP); \
	$(CD) $(LIBOPC_ZIP_BASE); \
	$(RMRF) $(LIBOPC_ZIP_SHIP_BASE); \
	$(MKDIRP) $(LIBOPC_ZIP_SHIP_BASE); \
	$(CD) $(LIBOPC_ZIP_BASE); \
	$(CP) $(LIBOSBDIR)$(LIB_PREFIX)$(LIBOPCSONAME).$(SO_EXT) $(LIBOPC_ZIP_SHIP_BASE); \
	$(CP) $(ORACLE_HOME)/rdbms/admin/bulkimport.pl $(LIBOPC_ZIP_SHIP_BASE); \
	$(CP) $(ORACLE_HOME)/rdbms/admin/odbsrmt.pl $(LIBOPC_ZIP_SHIP_BASE); \
	$(CD) $(LIBOPC_ZIP_BASE); \
	$(CD) $(LIBOPC_ZIP_SHIP_DIR); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=xmlgen \
         --libtype=opc \
         --libpath=$(LIBOSBDIR)$(LIB_PREFIX)$(LIBOPCSONAME).$(SO_EXT); \
	$(ZIPEXE) $(LIBOPC_ZIP) *; \
	$(CD) $(LIBOPC_ZIP_BASE); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=platformrename \
...
BUILD_LIBRA_ZIP=$(RMF) $(LIBRA_ZIP); \
	$(CD) $(LIBRA_ZIP_BASE); \
	$(RMRF) $(LIBRA_ZIP_SHIP_BASE); \
	$(MKDIRP) $(LIBRA_ZIP_SHIP_BASE); \
	$(CD) $(LIBRA_ZIP_BASE); \
	$(CP) $(LIBOSBDIR)$(LIB_PREFIX)$(LIBRASONAME).$(SO_EXT) $(LIBRA_ZIP_SHIP_BASE); \
	$(CD) $(LIBRA_ZIP_BASE); \
	$(CD) $(LIBRA_ZIP_SHIP_DIR); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=xmlgen \
         --libtype=ra \
         --libpath=$(LIBOSBDIR)$(LIB_PREFIX)$(LIBRASONAME).$(SO_EXT); \
	$(ZIPEXE) $(LIBRA_ZIP) *; \
	$(CD) $(LIBRA_ZIP_BASE); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=platformrename \
...
BUILD_LIBOSBWS_ZIP=$(RMF) $(LIBOSBWS_ZIP); \
	$(CD) $(LIBOSBWS_ZIP_BASE); \
	$(RMRF) $(LIBOSBWS_ZIP_SHIP_BASE); \
	$(MKDIRP) $(LIBOSBWS_ZIP_SHIP_BASE); \
	$(CD) $(LIBOSBWS_ZIP_BASE); \
	$(CP) $(LIBOSBDIR)$(LIB_PREFIX)$(LIBOSBWSSONAME).$(SO_EXT) $(LIBOSBWS_ZIP_SHIP_BASE); \
	$(CD) $(LIBOSBWS_ZIP_BASE); \
	$(CD) $(LIBOSBWS_ZIP_SHIP_DIR); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=xmlgen \
         --libtype=osbws \
         --libpath=$(LIBOSBDIR)$(LIB_PREFIX)$(LIBOSBWSSONAME).$(SO_EXT); \
	$(ZIPEXE) $(LIBOSBWS_ZIP) *; \
	$(CD) $(LIBOSBWS_ZIP_BASE); \
        $(PERL) $(ORACLE_HOME)/rdbms/src/generic/backup/osbws/libzipgen.pl \
         --mode=platformrename \
...
PACKAGE_LIBOSBZIP=$(BUILD_LIBOPC_ZIP) \
              $(BUILD_LIBRA_ZIP) \
              $(BUILD_LIBOSBWS_ZIP) 
...
LLIBOPCODM=$(LDLIBFLAG)$(ILIB_PREFIX)opcodm$(RDBMS_VERSION)$(ILIB_SUFFIX)
LIBOPCODM=$(LIBHOME)$(LIB_PREFIX)opcodm$(RDBMS_VERSION).$(DEPSO_EXT)
LOC_LIBOPCODM=$(RDBMSLIB)$(LIB_PREFIX)opcodm$(RDBMS_VERSION).$(LIB_EXT)
CPODM_OPC=$(CP) $(LIBOPCODM) $(RDBMSLIB)odm/$(LIB_PREFIX)opcodm$(RDBMS_VERSION).$(SO_EXT)
...
$(LIB_PREFIX)kubsagt.ohso\
$(LIB_PREFIX)xdb.ohso\
$(LIB_PREFIX)oramysql$(RDBMS_VERSION).ohso\
$(S_OHSO_TARGETS)
PRODSO_TARGETS=
...
LIBKUBSAGT=$(LIBHOME)$(LIB_PREFIX)kubsagt.$(SO_EXT)
...
LIB_EDITION_PREFIX=$(LIBHOME)$(LIB_PREFIX)$(LIBEDTNNAME)
LIB_EDITION_SUFFIX=.$(LIB_EXT)
SO_EDITION_PREFIX=$(SOHOME)$(LIB_PREFIX)$(LIBEDTNNAME)
SO_EDITION_ACTIVE_SUFFIX=.$(SO_EXT)
SO_EDITION_DISABLE_SUFFIX=.$(SO_EXT).dbl
EDITION_PREFIX=$(LIB_EDITION_PREFIX)
EDITION_ACTIVE_SUFFIX=$(LIB_EDITION_SUFFIX)
EDITION_DISABLE_SUFFIX=$(LIB_EDITION_SUFFIX)

LIBEDTN_ENT=$(EDITION_PREFIX)_ent$(EDITION_DISABLE_SUFFIX)
LIBEDTN_STD=$(EDITION_PREFIX)_std$(EDITION_DISABLE_SUFFIX)
LIBEDTN_CEE=$(EDITION_PREFIX)_cee$(EDITION_DISABLE_SUFFIX)
LIBEDTN_CSE=$(EDITION_PREFIX)_cse$(EDITION_DISABLE_SUFFIX)
LIBEDTN_HP=$(EDITION_PREFIX)_hp$(EDITION_DISABLE_SUFFIX)
LIBEDTN_XP=$(EDITION_PREFIX)_xp$(EDITION_DISABLE_SUFFIX)
LIBEDTN_XE=$(EDITION_PREFIX)_xe$(EDITION_DISABLE_SUFFIX)
LIBEDTN_BACKUP=$(EDITION_PREFIX)_backup$(EDITION_DISABLE_SUFFIX)
...
FBCOMMAND_POSTBUILD=(\
	$(FBCOMMAND_POSTBUILD_FIRST)\
	$(FBCOMMAND_POSTBUILD_SECOND)\
	)

FBCOMMAND_POSTBUILD1=(\
	$(FBCOMMAND_POSTBUILD_FIRST)\
	)

FBCOMMAND_POSTBUILD2=(\
	$(FBCOMMAND_POSTBUILD_SECOND)\
	)
...
FBCOMMAND_POSTBUILD_FIRST=\
	...
	$(MAKE) $(MAPLIBS);\
	$(MAKE_LIBSKVOL);\
	$(MAKE) libxdb libdbguiss libkubsagt libhgotrace;\
	$(MAKE) $(LIBOCCI);\
	$(MAKE) clean_ocieiall;\
	$(MAKE) libocieiall;\
...
FBCOMMAND_POSTBUILD_SECOND=\
	$(GENCLNTST);\
	$(MAKE) $(LIBOSBWSSO) $(LIBRASO) $(LIBOPCSO);\
	...
	$(MAKE) libshpk;\
	$(MAKE_LIBRQEXT);\
	$(MAKE) -C $(CTXHOME) ctx_load;\

FBCOMMAND_BUILDINFO=(\
	$(MAKE) generate_manpages_log;\
	$(MAKE) generatebuildinfo_log;\
	if [ -e $(RDBMSHOME)/utl/xcscope.files ]; then \
		$(CD) $(RDBMSHOME)/utl; $(MAKE) ; \
		build_xcscope; \
	else \
		$(ECHO) "Skipping cscope compile"; \
	fi \
)
...
POST_LINK_TASKS=(\
	...
	$(COVERAGE_POST_LINK_TASKS) ;\
	$(MAKE) -C $(RDBMSUTL) files setup;\
	)

ifeq ($(COVERAGE_RUN),1)
  COVERAGE_JAVA_SETUP=$(PERL) $(RDBMSUTL)coverage_java_setup.pl

CC_SPI_FILE = $(ORACLE_HOME)/tklocal/pgopti.spi
COVERAGE_POST_LINK_TASKS=(\
	if [ -f $(CC_SPI_FILE) ]; then \
	  $(ECHO) "Copying $(CC_SPI_FILE) to $(RDBMSHOME)" ; \
	  $(CP) -f $(CC_SPI_FILE) $(RDBMSHOME) ; \
	else \
	  $(ECHO) "$(CC_SPI_FILE) is not present" ; \
	fi \
)
endif
...
CLIENT_RPM_VERSION = $(BANNERVERSIONFULL)
...
RPM_DEFINES = --define "_sourcedir $(LIBOCIEI_BASE)" --define "_builddir $(RPM_DIR)/BUILD" --define "_srcrpmdir $(RPM_DIR)/SRPMS" --define "_rpmdir $(RPM_DIR)/RPMS" --define "_tmppath $(RPM_DIR)/tmp" --define "install_dir $(RPM_INSTALL_DIR)" --define "default_version $(CLIENT_RPM_VERSION)" --define "rdbms_major $(RDBMS_VERSION)" --define "rdbms_minor_version $(VSNRU)" --define "client_lib_minor_version $(CLIENT_LIB_MINOR_VERSION)" --define "jdbc_current_jar $(JDBC_CURRENT_JDK_OPT_JAR_NAME)" $(DEFINE_NEXT_JAR_OPT) --define "sqlplus_exe $(RPM_SQLPLUS_EXE)" --define "debug_package %{nil}" --define "_enable_debug_package 0"
...
S_SHLIBS= $(LIBSKGXP) $(LIBSKGXN) $(S_LIBHGOTRACE) $(LIBSKJCX) $(LIBSHPK) $(LIBORAMALLOC)
...
libopcodm$(RDBMS_VERSION)LIBS=$(LINKLDLIBS)
...
LIBORAMALLOCNAME=oramalloc$(RDBMS_VERSION)
LIBORAMALLOC=$(RDBMSLIB)$(LIB_PREFIX)$(LIBORAMALLOCNAME).$(SO_EXT)
LOC_LIBORAMALLOC=$(RDBMSLIB)$(LIB_PREFIX)$(LIBORAMALLOCNAME).$(LIB_EXT)
liboramalloc$(RDBMS_VERSION)LIBS=$(LIBCLNTSH)
